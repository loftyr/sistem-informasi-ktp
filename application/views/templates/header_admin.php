    ...
    <div class="asside-left">
        <div class="asside-menu">
            <ul class="sidenav-m3 full-width">
                ...
                <li class="stick-left">
                    <a class="" href="<?= base_url('Data_Ktp') ?>"><span class="icon mif-book-reference"></span>Data KTP</a>
                </li>

                <li class="stick-left">
                    <a class="" href="<?= base_url('Lap_Data_Ktp') ?>"><span class="icon mif-book-reference"></span>Laporan Data KTP</a>
                </li>
            </ul>
        </div>
    </div>
